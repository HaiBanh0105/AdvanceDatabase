...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $check_sql = "SELECT user_id FROM Bank_account WHERE card_id = ?";
        $existing = db_query_one($check_sql, $card_id);
        ...
        $sql = "INSERT INTO Bank_account (card_id, user_id, provider, cardholder_name, CVV, expiry_date) VALUES (?, ?, ?, ?, ?, ?)";
        db_execute($sql, $card_id, $user_id, $provider, $cardholder_name, $cvv, $expiry_date);
