/** File xử lý Giao diện Khôi phục mật khẩu */
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (step1Form) {
        step1Form.addEventListener("submit", function (e) {
            ...
            fetch("../actions/process_reset_password.php", {
                method: "POST",
                body: new FormData(this),
            }).then(res => res.json()).then(data => {
                document.getElementById("btnStep1").disabled = false;
                document.getElementById("textStep1").innerText = "Gửi mã OTP";
                ...
                if (data.status === "success") {
                    ...
                    if(descText) descText.innerText = "Kiểm tra hòm thư của bạn và nhập mã OTP bên dưới.";
                } else {
    ...
    if (step2Form) {
        step2Form.addEventListener("submit", function (e) {
            ...
            fetch("../actions/process_reset_password.php", {
                ...
                document.getElementById("textStep2").innerText = "Đổi mật khẩu";
