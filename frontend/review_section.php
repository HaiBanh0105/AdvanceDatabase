<style>
    /* CSS cho thanh đánh giá sao tương tác */
    .star-rating { display: flex; flex-direction: row-reverse; justify-content: flex-end; gap: 4px; }
    .star-rating input { display: none; }
    .star-rating label { cursor: pointer; color: #cbd5e1; font-size: 1.75rem; transition: color 0.2s; }
    .star-rating input:checked ~ label { color: #facc15; }
    .star-rating label:hover,
    .star-rating label:hover ~ label { color: #facc15 !important; }
</style>
...
<section id="reviews" class="py-24 bg-indigo-50/50 border-t border-slate-100">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
            <!-- CỘT TRÁI: FORM ĐÁNH GIÁ (Chiếm 5 phần) -->
            <div class="lg:col-span-5 h-fit sticky top-24">
                ...
                <?php elseif (!$has_reviewed): ?>
                    ...
                    <div class="bg-white p-8 rounded-[2rem] shadow-xl shadow-slate-200/50 border border-slate-100 relative overflow-hidden">
                        ...
                        <h3 class="text-xl font-black text-slate-800 mb-6 flex items-center gap-3"><i class="fa-solid fa-pen-to-square text-indigo-500"></i> Viết đánh giá</h3>
                ...
                <?php else: ?>
                    ...
                    <div class="bg-white p-8 rounded-[2rem] shadow-xl shadow-slate-200/50 border border-slate-100 relative overflow-hidden">
                        ...
                        <h3 class="text-xl font-black text-slate-800 mb-6 flex items-center gap-3"><i class="fa-solid fa-pen-to-square text-amber-500"></i> Quản lý đánh giá</h3>
                        <form action="../actions/process_review.php" method="POST">
                            <div class="mb-5">
                                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Chấm điểm dịch vụ</label>
                                <div class="star-rating">
                    ...
                    <div class="pr-2 space-y-4 max-h-[500px] overflow-y-auto scroll-smooth" style="scrollbar-width: thin; scrollbar-color: #cbd5e1 transparent;">
                        ...
                        <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 hover:shadow-md transition duration-300 flex gap-5">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-slate-600 text-sm leading-relaxed">"<?php echo htmlspecialchars($rv['comment']); ?>"</p>
                            </div>
                        </div>
                        <?php endforeach; ?>
                    </div>
