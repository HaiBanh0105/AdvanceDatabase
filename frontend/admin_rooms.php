                        ...
                        <?php else: ?>
                            <?php foreach ($room_types as $rt): ?>
                                <tr class="hover:bg-slate-50/50 transition">
                                    ...
                                    <td class="px-6 py-4 text-indigo-600 font-bold"><?php echo number_format($rt['price_per_hour'], 0, ',', '.'); ?>đ</td>
                                    <td class="px-6 py-4 text-rose-600 font-bold"><?php echo number_format($rt['price_per_day'], 0, ',', '.'); ?>đ</td>
                                    ...
                                    <td class="px-6 py-4 text-right space-x-2">
                                        <button onclick="openEditTypeModal(<?php echo $rt['type_id']; ?>, '<?php echo htmlspecialchars(addslashes($rt['name'])); ?>', <?php echo $rt['price_per_hour']; ?>, <?php echo $rt['price_per_day']; ?>, <?php echo $rt['capacity']; ?>, '<?php echo htmlspecialchars(addslashes($rt['description'] ?? '')); ?>')" class="text-amber-500 hover:text-amber-700 bg-amber-50 p-2 rounded-lg transition" title="Sửa"><i class="fa-solid fa-pen-to-square"></i></button>
        ...
        <div class="bg-white rounded-[2.5rem] w-full max-w-lg shadow-2xl overflow-hidden animate-in zoom-in duration-300">
            ...
            <form id="addTypeForm" action="../actions/process_add_room_type.php" method="POST" enctype="multipart/form-data" class="p-8 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Giá / Giờ</label>
                        <input type="number" name="price_per_hour" required class="w-full px-5 py-3 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all">
                    </div>
                    <div>
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Giá / Ngày</label>
                        <input type="number" name="price_per_day" required class="w-full px-5 py-3 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all">
                    </div>
                    <div>
        ...
        <div class="bg-white rounded-[2.5rem] w-full max-w-lg shadow-2xl overflow-hidden animate-in zoom-in duration-300">
            ...
            <form id="editTypeForm" action="../actions/process_add_room_type.php" method="POST" enctype="multipart/form-data" class="p-8 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Giá / Giờ</label>
                        <input type="number" name="price_per_hour" id="edit_type_price_hr" required class="w-full px-5 py-3 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all">
                    </div>
                    <div>
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Giá / Ngày</label>
                        <input type="number" name="price_per_day" id="edit_type_price_day" required class="w-full px-5 py-3 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all">
                    </div>
                    <div>
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Sức chứa</label>
