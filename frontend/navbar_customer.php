...
<nav class="fixed w-full z-50 bg-white/90 backdrop-blur-md border-b border-gray-100">
    <div class="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
        ...
        <div class="hidden md:flex items-center space-x-10 text-sm font-semibold">
            ...
            <a href="customer_promotions.php" class="<?php echo ($current_page == 'customer_promotions.php') ? 'text-indigo-600 border-b-2 border-indigo-600' : 'text-gray-600 hover:text-indigo-600'; ?> pb-1 transition">Khuyến mãi</a>
        ...
        <div class="flex items-center gap-6">
            <div class="text-right border-r pr-6 hidden sm:block">
                ...
                <a href="customer_profile.php" class="text-sm font-bold text-indigo-600 hover:text-indigo-800 hover:underline transition" title="Xem hồ sơ của bạn"><?php echo htmlspecialchars($full_name); ?></a>
            </div>
