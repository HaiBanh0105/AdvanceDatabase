<div id="editTypeModal"
    ...
    <div
        class="bg-white rounded-[2.5rem] w-full max-w-lg shadow-2xl overflow-hidden animate-in zoom-in duration-300 max-h-[90vh] flex flex-col">
        ...
        <form id="editTypeForm" action="../actions/process_add_room_type.php" method="POST"
            enctype="multipart/form-data" class="p-8 space-y-4 overflow-y-auto">
